                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row justify-content-between">
                                            <div class="col-auto col-md-7">
                                                <div class="media flex-column flex-sm-row"> <img class=" img-fluid" src="{{ asset('upload/'.$products->image1) }}" width="62" height="62">
                                                    <div class="media-body my-auto" style="padding-left: 5px;">
                                                        <div class="row ">
                                                            <div class="col-auto">
                                                                <p class="mb-0"><b>{{ $products->name_product }}</b></p><small class="text-muted">{{ $products->categories->name }}<b>&</b>{{ $products->brands->name}}</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class=" pl-0 flex-sm-col col-auto my-auto">
                                                <p class="boxed-1">{{ $products->quantity }}</p>
                                            </div>
                                            <div class=" pl-0 flex-sm-col col-auto my-auto ">
                                                {{number_format($products->price * $products->quantity,0,'.','.')}}
                                            </div>
                                        </div>
                                        <hr class="my-2">
